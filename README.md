...
## 🎯 Key Features
- **Multi-Page Architecture:** Cleanly structured routing across four distinct sections: Home, About Me, Projects, and a Contact page.
- **Centralized Project Hub:** Acts as the primary directory linking directly to deployed applications like the Movie Finder and Task Manager.
